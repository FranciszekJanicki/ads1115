...
static ads1115_err_t ads1115_bus_initialize(ads1115_t const *ads1115) {
  return ads1115->interface.bus_initialize
             ? ads1115->interface.bus_initialize(ads1115->interface.bus_user)
             : ADS1115_ERR_NULL;
}

static ads1115_err_t ads1115_bus_deinitialize(ads1115_t const *ads1115) {
  return ads1115->interface.bus_deinitialize
             ? ads1115->interface.bus_deinitialize(ads1115->interface.bus_user)
             : ADS1115_ERR_NULL;
}

static ads1115_err_t ads1115_bus_write_data(ads1115_t const *ads1115,
                                            uint8_t address,
                                            uint8_t const *data,
                                            size_t data_size) {
  return ads1115->interface.bus_write_data
             ? ads1115->interface.bus_write_data(ads1115->interface.bus_user,
                                                 address, data, data_size)
             : ADS1115_ERR_NULL;
}

static ads1115_err_t ads1115_bus_read_data(ads1115_t const *ads1115,
                                           uint8_t address, uint8_t *data,
                                           size_t data_size) {
  return ads1115->interface.bus_read_data
             ? ads1115->interface.bus_read_data(ads1115->interface.bus_user,
                                                address, data, data_size)
             : ADS1115_ERR_NULL;
}

ads1115_err_t ads1115_initialize(ads1115_t *ads1115, ads1115_config_t *config,
  ...
  return ads1115_bus_initialize(ads1115);
}

ads1115_err_t ads1115_deinitialize(ads1115_t *ads1115) {
  assert(ads1115);

  ads1115_err_t err = ads1115_bus_deinitialize(ads1115);
...
ads1115_err_t ads1115_get_conversion_scaled(ads1115_t const *ads1115,
                                            float32_t *scaled) {
  assert(ads1115);
...
ads1115_err_t ads1115_get_conversion_raw(ads1115_t const *ads1115,
                                         int16_t *raw) {
  assert(ads1115);
...
ads1115_err_t ads1115_get_conversion_reg(ads1115_t const *ads1115,
  ...
  ads1115_err_t err = ads1115_bus_read_data(
      ads1115, ADS1115_REG_ADDR_CONVERSION, data, sizeof(data));
...
ads1115_err_t ads1115_get_config_reg(ads1115_t const *ads1115,
  ...
  ads1115_err_t err = ads1115_bus_read_data(ads1115, ADS1115_REG_ADDR_CONFIG,
                                            data, sizeof(data));
...
ads1115_err_t ads1115_set_config_reg(ads1115_t const *ads1115,
  ...
  return ads1115_bus_write_data(ads1115, ADS1115_REG_ADDR_CONFIG, data,
                                sizeof(data));
}
...
ads1115_err_t ads1115_get_lo_thresh_reg(ads1115_t const *ads1115,
  ...
  ads1115_err_t err = ads1115_bus_read_data(ads1115, ADS1115_REG_ADDR_LO_THRESH,
                                            data, sizeof(data));
...
ads1115_err_t ads1115_set_lo_thresh_reg(ads1115_t const *ads1115,
  ...
  return ads1115_bus_write_data(ads1115, ADS1115_REG_ADDR_LO_THRESH, data,
                                sizeof(data));
}
...
ads1115_err_t ads1115_get_hi_thresh_reg(ads1115_t const *ads1115,
  ...
  ads1115_err_t err = ads1115_bus_read_data(ads1115, ADS1115_REG_ADDR_HI_THRESH,
                                            data, sizeof(data));
...
ads1115_err_t ads1115_set_hi_thresh_reg(ads1115_t const *ads1115,
  ...
  return ads1115_bus_write_data(ads1115, ADS1115_REG_ADDR_HI_THRESH, data,
                                sizeof(data));
}
