...
typedef enum {
    ADS1115_DEV_ADDR_AD0_GND = 0b1001000,
    ADS1115_DEV_ADDR_AD0_VDD = 0b1001001,
    ADS1115_DEV_ADDR_AD0_SDA = 0b1001010,
    ADS1115_DEV_ADDR_AD0_SCL = 0b1001011,
} ads1115_dev_addr_t;

typedef enum {
    ADS1115_REG_ADDR_CONVERSION = 0b00,
    ADS1115_REG_ADDR_CONFIG = 0b01,
    ADS1115_REG_ADDR_LO_THRESH = 0b10,
    ADS1115_REG_ADDR_HI_THRESH = 0b11,
} ads1115_reg_addr_t;

typedef enum {
    ADS1115_MUX_P_AIN0_N_AIN1 = 0b000,
    ADS1115_MUX_P_AIN0_N_AIN3 = 0b001,
    ADS1115_MUX_P_AIN1_N_AIN3 = 0b010,
    ADS1115_MUX_P_AIN2_N_AIN3 = 0b011,
    ADS1115_MUX_P_AIN0_N_GND = 0b100,
    ADS1115_MUX_P_AIN1_N_GND = 0b101,
    ADS1115_MUX_P_AIN2_N_GND = 0b110,
    ADS1115_MUX_P_AIN3_N_GND = 0b111,
} ads1115_mux_t;
...
typedef struct {
    void* bus_user;
    ads1115_err_t (*bus_init)(void*);
    ads1115_err_t (*bus_deinit)(void*);
    ads1115_err_t (*bus_write)(void*, uint8_t, uint8_t const*, size_t);
    ads1115_err_t (*bus_read)(void*, uint8_t, uint8_t*, size_t);
} ads1115_interface_t;
